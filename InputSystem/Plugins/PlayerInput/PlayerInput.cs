        ...
        private void OnActionTriggered(InputAction.CallbackContext context)
        {
            ...
            switch (m_NotificationBehavior)
            {
                ...
                case PlayerNotifications.SendMessages:
                    ...
                    //    return;
                    // So actually this is stupid - Tezemi
                    ...
                    if (m_NotificationBehavior == PlayerNotifications.BroadcastMessages)
                        ...
                        BroadcastMessage(messageName, context, SendMessageOptions.DontRequireReceiver);
                    else
                        //SendMessage(messageName, m_InputValueObject, SendMessageOptions.DontRequireReceiver);
                        SendMessage(messageName, context, SendMessageOptions.DontRequireReceiver);

                    // No reason these shouldn't send the entire context - Tezemi
